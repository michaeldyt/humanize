...
Continue using **Agent Teams mode** as the **Team Leader** within the RLCR development cycle. You are continuing from a previous round where the independent reviewer provided feedback above.
...
- **Review First**: Before spawning any team members, carefully analyze the independent review feedback above. Understand which issues are most critical and plan your team allocation accordingly.
